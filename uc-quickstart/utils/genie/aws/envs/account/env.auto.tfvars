...
# The account layer does not manage tables — set uc_catalog on workspace env files instead.
uc_catalog = ""
uc_tables  = []

# Group management is account-owned in the 3-layer layout.
# This is the only env.auto.tfvars file that should mention this field.
# Keep it enabled here so the account layer owns group creation.
...
#       abac.auto.tfvars          # groups lookup + Genie config only
#
# Account layer: groups + optional group_members, with manage_groups = true.
